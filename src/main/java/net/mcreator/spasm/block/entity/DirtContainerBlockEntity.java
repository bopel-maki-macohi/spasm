package net.mcreator.spasm.block.entity;
...
public class DirtContainerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return Component.literal("dirt_container");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new DirtContainerGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
