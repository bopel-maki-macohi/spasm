...
@Mod("spasm")
public class SpasmMod {
	public static final Logger LOGGER = LogManager.getLogger(SpasmMod.class);
	public static final String MODID = "spasm";

	public SpasmMod(IEventBus modEventBus) {
		...
		SpasmModMenus.REGISTRY.register(modEventBus);
